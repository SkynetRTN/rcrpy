...
#    - rcrpy/pyproject.toml:  [project] version = "x.y.z"
#    - rcrpy/src/rcrpy/__init__.py:  __version__ = "x.y.z"
#    (These must match.)
...
ls rcrpy/dist/   # should show rcrpy-x.y.z-py3-none-any.whl and rcrpy-x.y.z.tar.gz

# 4. Install the BUILT wheel in a CLEAN venv and smoke-test it.
python -m venv /tmp/rcrpy-clean
/tmp/rcrpy-clean/bin/python -m pip install rcrpy/dist/rcrpy-x.y.z-py3-none-any.whl
/tmp/rcrpy-clean/bin/python rcrpy/smoke_install.py
...
python -m twine upload --repository testpypi rcrpy/dist/rcrpy-x.y.z*
...
python -m twine upload rcrpy/dist/rcrpy-x.y.z*
