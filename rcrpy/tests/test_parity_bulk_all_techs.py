...
@pytest.mark.parametrize("tech_name,port_tech,oracle_tech,sigma_kind", [
    ("LS_MODE_68",   rcrpy.RejectionTech.LS_MODE_68,   None, "lower"),
    ("LS_MODE_DL",   rcrpy.RejectionTech.LS_MODE_DL,   None, "lower"),
    ("SS_MEDIAN_DL", rcrpy.RejectionTech.SS_MEDIAN_DL, None, "single"),
    ("ES_MODE_DL",   rcrpy.RejectionTech.ES_MODE_DL,   None, "each"),
])
